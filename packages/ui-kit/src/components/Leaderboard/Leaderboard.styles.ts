...
export const getContainerStyles = (styles?: ChartStyles) => css`
  overflow: auto;
...
export const getTableHeadStyles = (styles?: ChartStyles) => css`
...
export const getTableHeaderStyles = (styles?: ChartStyles) => css`
  padding: ${styles?.table?.padding || defaultStyles.table.padding};
  font-weight: ${styles?.table?.header?.font?.weight || defaultStyles.table.header.font.weight};
`

export const getTableValueHeaderStyles = (styles?: ChartStyles) => css`
  position: sticky;
  right: 0;
...
export const getTableBodyStyles = (styles?: ChartStyles) => css`
...
export const getTableCellStyles = (styles?: ChartStyles) => css`
  padding: ${styles?.table?.padding || defaultStyles.table?.padding};
  background-color: ${styles?.table?.backgroundColor || defaultStyles.table.backgroundColor};
  border-top: 1px solid #e6e8f0;
`

export const getTableValueCellStyles = (styles?: ChartStyles) => css`
