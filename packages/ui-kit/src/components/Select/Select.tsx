...
export function Select({ options, placeholder }: Props) {
  ...
  return (
    ...
    <div>
      ...
      <button {...getButtonProps()} style={{ '--color': value } as any}>
        {renderSelectedValue(value, options) || <span className="placeholder">{placeholder ?? ' '}</span>}
        {/* <UnfoldMoreRoundedIcon /> */}@{/* </Toggle> */}
      </button>
      {/* <Listbox {...getListboxProps()} aria-hidden={!listboxVisible} className={listboxVisible ? '' : 'hidden'}> */}
      <ul {...getListboxProps()} aria-hidden={!listboxVisible} className={listboxVisible ? '' : 'hidden'}>
