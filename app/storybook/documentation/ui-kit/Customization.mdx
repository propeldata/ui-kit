...
This will change the color of the bars to a shade of purple, as shown in the following output:

<Story of={TimeSeriesStories.CustomStyleStory} />
...
This will display a custom error message with a title and body text, as shown in the following output:

<Story of={TimeSeriesStories.ErrorStory} />
