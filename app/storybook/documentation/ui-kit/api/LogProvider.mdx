...
For example, when you set up log level as "error" to display a error message when the Counter component's chart data cannot be loaded, you can use the following
JavaScript code:
