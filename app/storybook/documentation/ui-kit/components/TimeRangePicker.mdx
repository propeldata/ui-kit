...
allows users to pick a predefined range, a custom fixed date range, or a dynamic period up to the current date, with
...
- <LinkTo kind="API/DateRangeOptionValue" story="overview">
    DateRangeOptionValue
  </LinkTo>
