...
The SimpleFilter component is a dropdown designed to build Propel metric filters and supply them to the components in
...
This components require wrapping you application in a `FilterProvider` which will provide the built filter to the child components.
