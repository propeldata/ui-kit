...
The theme determines essential visual elements including the colors of components, the darkness of surfaces, the
intensity of shadows, and the opacity of ink elements. We provide both light and dark themes, with the light theme set
as the default.
