...
Propel's Query Hooks works with react-query. That means, you need to setup the [QueryClientProvider](https://tanstack.com/query/latest/docs/react/reference/QueryClientProvider).

#### List of query hooks

- <LinkTo kind="Hooks/useCounter" story="overview">useCounter</LinkTo>
- <LinkTo kind="Hooks/useDataGrid" story="overview">useDataGrid</LinkTo>
- <LinkTo kind="Hooks/useLeaderboard" story="overview">useLeaderboard</LinkTo>
- <LinkTo kind="Hooks/useRecordsById" story="overview">useRecordsById</LinkTo>
- <LinkTo kind="Hooks/useSql" story="overview">useSql</LinkTo>
- <LinkTo kind="Hooks/useTimeSeries" story="overview">useTimeSeries</LinkTo>
- <LinkTo kind="Hooks/useTopValues" story="overview">useTopValues</LinkTo>
